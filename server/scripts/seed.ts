  ...
  // Emma Schmidt (hired, score: 96)
  {
    ...
    scores: [
      ...
      },
      {
        ...
        evidence: '7 years of production web application development. Last 4 years at B2B SaaS companies building workflow-heavy internal tools. Previous role involved building a recruitment-adjacent HR platform, directly relevant to Kush Talents\'s domain.',
  ...
  // Amara Okafor (screening, score: 78)
  {
    ...
    scores: [
      ...
      },
      {
        ...
        evidence: '4 years of web development. Current role at a multi-tenant SaaS company building B2B collaboration tools. Strong domain relevance for Kush Talents.',
