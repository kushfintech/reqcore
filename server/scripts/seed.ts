/**
 * Seeds the database with realistic demo data for Kush ATS.
 *
 * Creates:
 * - 1 demo user (demo@reqcore.com / demo1234)
 * - 1 organization ("Kush ATS Demo")
...
const DEMO_ORG_NAME = 'Kush ATS Demo'
  ...
  // Emma Schmidt (hired, score: 96)
  {
    ...
    scores: [
      ...
      },
      {
        ...
        evidence: '7 years of production web application development. Last 4 years at B2B SaaS companies building workflow-heavy internal tools. Previous role involved building a recruitment-adjacent HR platform, directly relevant to Kush ATS\'s domain.',
  ...
  // Amara Okafor (screening, score: 78)
  {
    ...
    scores: [
      ...
      },
      {
        ...
        evidence: '4 years of web development. Current role at a multi-tenant SaaS company building B2B collaboration tools. Strong domain relevance for Kush ATS.',
...
const INTERVIEWS_DATA: InterviewSeed[] = [
  ...
  },
  {
    ...
    location: 'Kush ATS HQ, Friedrichstraße 123, Berlin',
...
async function seed() {
  console.log('🌱 Seeding Kush ATS demo data...\n')
