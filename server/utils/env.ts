...
export const envSchema = z
  .object({
    ...
    /** Sender email address for Resend emails. Must be a verified domain in Resend. Defaults to "Kush ATS <noreply@reqcore.com>". */
    RESEND_FROM_EMAIL: emptyToUndefined
      .pipe(z.string().min(1))
      .optional()
      .default("Kush ATS <noreply@reqcore.com>"),
    ...
    /** Sender address for SMTP emails. Defaults to "Kush ATS <noreply@reqcore.com>". */
    ...
    if (!(globalThis as Record<string, unknown>).__env) {
      ...
      if (!result.success) {
        const missing = result.error.issues
          ...
          .join("\n");
        console.error(
          `\n[Kush ATS] ❌ Missing or invalid environment variables:\n${missing}\n\n` +
