...
useSeoMeta({
  title: 'Accept Invitation — Kush Talents',
  description: 'Accept an organization invitation on Kush Talents',
...
<template>
  ...
  <div v-else class="flex flex-col gap-5">
    <div class="text-center">
      ...
      <p class="text-sm text-surface-500 dark:text-surface-400">
        You've been invited to join an organization on Kush Talents.
      </p>
    </div>
